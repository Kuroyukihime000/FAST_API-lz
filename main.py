...
#Подгрузка стилей для html и картинок
...
#Работа с сессией, ещё запись и завершение
@app.middleware("http")
...
#Страница входа в аккаунт, проверка существует ли такой user
@app.post("/login")
def login(
    request: Request,
    username: str = Form(...),
...
#Logout выход и завершение сессии 
...
#Запрос на страницу регистрации(от обычного user запрещенно)
...
#Регистрация с проверкой данным администратора
@app.post("/register")
...
#Запрос на страницу с преветсвием 
...
#Разрешение страницы статус 403
